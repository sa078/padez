                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
					 ...
					 <input type="hidden" name="oldslider" value="<?php echo $editdata['image'];?>">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" name="heading" placeholder="Heading" value="<?php echo $editdata['heading'];?>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">URL</label>
                        <input type="text" name="url" class="form-control" value="<?php echo $editdata['url'];?>" id="exampleInputEmail3" placeholder="URL">
                      </div>
