                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
					 ...
					 <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" name="name" placeholder="Service Name" value="<?php echo $editdata['name'];?>">
                      </div>
					  
					   <div class="form-group">
					   
					    <img src="uploads/<?php echo $editdata['icon'];?>" style="height:100px;">
